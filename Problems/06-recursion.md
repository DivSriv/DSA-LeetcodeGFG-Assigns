...
- [x] [Perfect squares](https://leetcode.com/problems/perfect-squares/)`leetcode`
...
- [x] [Lowest Common Ancestor of a Binary Tree](https://practice.geeksforgeeks.org/problems/lowest-common-ancestor-in-a-binary-tree/1/) `GFG` `Amex`
